...
export const inputs =
    {
            ...
            items: [
                ...
                },
                {
                    ...
                    items: [
                        ...
                        {value: 'Панорамное (с одной стороны)', text: 'Панорамное окно (с одной стороны)'},
                    ],
                },
                {
                    disabled: disabled,
        ...
        buildingClass: (disabled) => ({
            ...
            items: {
                ...
                cottage: [
                    {value: 'Коттедж/Дом/Таунхаус', text: 'Коттедж/Дом/Таунхаус'},
                ],
                commercial: [
                    ...
                    {value: 'Военные объекты/Объекты силовых ведоств', text: 'Военные объекты/Объекты силовых ведоств'},
                    ...
                    {value: 'Сетевые мед. центры/стомоталогии', text: 'Сетевые мед. центры/стомоталогии'},
        ...
        serviceType: (disabled) => ({
            ...
            items: [
                ...
                {value: 'Послестроительная уборка(комплексная)', text: 'Послестроительная уборка(комплексная)'},
        ...
        services: (disabled, serviceType) => ({
            ...
            inputs: [
                {name: 'name', title: 'Наименование работ', default: "", multiline: true, required: true},
                {
                    name: 'note',
                    title: 'Примечание',
                    default: "",
        ...
        contractServices: (disabled, serviceType) => ({
            ...
            inputs: [
                ...
                {name: 'note', title: 'Примечание', default: "", className: 'table__td_40', required: false}
            ]
        }),
        attractionSource: (disabled) => ({
            ...
            items: [
                ...
                {value: 'Таргетированная реклама (Instagram)', text: 'Таргетированная реклама (Instagram)'},
